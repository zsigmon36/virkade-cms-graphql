...
public class ConstantsDAO {
	...
	public static final String OWNER_USER_FNAME = "Virkade";
	public static final String OWNER_USER_LNAME = "Experience";
	public static final String OWNER_USER_UNAME = "VirkadeExperience";
